...
const classes = computed<string[]>(() => {
    const tmp: string[] = [];
    if (props.light) tmp.push('brand-logo--light');
    if (props.vertical) tmp.push('brand-logo--vertical');
    return tmp;
});
</script>

<template lang="pug">
    div(class="brand-logo" :class="classes")
